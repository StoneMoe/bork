...
func (recordingNativeSink) tcpConnectRequest(nativeTCPConnectRequestEvent) uint16 { return 0 }
...
func (recordingNativeSink) endpointError(*NativeCallbackError)                    {}
...
type recordingNativeSDK struct {
	...
	postHook       func()
	setRulesStatus nativeStatus
	postTCPStatus  nativeStatus
	closeTCPStatus nativeStatus
	postUDPStatus  nativeStatus
	suspendStatus  nativeStatus
}
...
func (sdk *recordingNativeSDK) SetRules(uint64, []nativeRule) nativeStatus {
	sdk.record("set rules")
	return sdk.setRulesStatus
}
