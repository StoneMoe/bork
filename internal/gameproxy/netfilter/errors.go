...
var (
	...
	ErrTCPRedirectUnavailable  = errors.New("netfilter: TCP redirect unavailable")
	ErrTCPRedirectMapping      = errors.New("netfilter: TCP redirect mapping missing")
	ErrTCPRedirectOwner        = errors.New("netfilter: TCP redirect ownership not verified")
