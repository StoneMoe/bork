...
#define BORK_LOAD(field, type, name) do { \
    ...
    BORK_LOAD(tcp_post_send, bork_tcp_post_send_fn, "nf_tcpPostSend");
    BORK_LOAD(tcp_post_receive, bork_tcp_post_receive_fn, "nf_tcpPostReceive");
    BORK_LOAD(tcp_close, bork_tcp_close_fn, "nf_tcpClose");
    BORK_LOAD(tcp_disable_filtering, bork_tcp_disable_filtering_fn, "nf_tcpDisableFiltering");
    ...
    BORK_LOAD(udp_disable_filtering, bork_udp_disable_filtering_fn, "nf_udpDisableFiltering");
    ...
    BORK_LOAD(get_process_name_kernel, bork_get_process_name_fn, "nf_getProcessNameFromKernel");
    BORK_LOAD(adjust_process_privileges, bork_adjust_process_privileges_fn, "nf_adjustProcessPriviledges");
#undef BORK_LOAD
    return 1;
}
